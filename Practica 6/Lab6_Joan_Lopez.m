...
subplot(2,2,1), imshow(speckle_1), title('speckle en imagen 1');
subplot(2,2,2), imshow(speckle_2), title('speckle en imagen 2');
subplot(2,2,3), imshow(speckle_3), title('speckle en imagen 3');
subplot(2,2,4), imshow(speckle_4), title('speckle en imagen 4');
